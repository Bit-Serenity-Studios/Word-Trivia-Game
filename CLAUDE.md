...
asset library: **[Bit-Serenity-Studios/KennyNLAssets](https://github.com/Bit-Serenity-Studios/KennyNLAssets)**.
...
- **Don't re-download from origin sites** (kenney.nl, quaternius.com, polyhaven.com,
  ambientcg.com). Take the copy from KennyNLAssets so every project ships identical
  asset versions.
